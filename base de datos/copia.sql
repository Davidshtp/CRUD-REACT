...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `nacimiento` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `fecha` date NOT NULL,
  `identificacion` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `usuarios` (`id`, `nombres`, `apellidos`, `correo`, `telefono`, `edad`, `nacimiento`, `fecha`, `identificacion`) VALUES
	(58, 'david alexis', 'medina', 'dadad', '3138476166', 17, 'mocoa', '2024-03-30', 1118366640);
